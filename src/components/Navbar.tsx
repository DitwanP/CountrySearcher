...
const Navbar = (props: NavbarProps) => {
  ...
  return (
    <div className="custom-shadow fixed top-0 z-50 h-[80px] w-full bg-light-mode-bg px-14 drop-shadow-md transition-colors duration-150 ease-out dark:bg-dark-mode-bg">
